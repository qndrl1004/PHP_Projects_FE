...
<script src="./js/greet.js"></script>
    ...
    <p class="emphasis serif">
        정보화 시대에 <b class="point">빠른정보를 원하는 우리들에게</b> 인터넷은 <br>
        <b class="point">하나의 거대한 생활공간</b>이 되었습니다.
    </p>
    <p>
    ...
    <p>
         ...
         고객님의 요구에 기획부터 홈페이지에 필요한 이미지 촬영,전자카다로그 제작,포탈싸이트 등록,키워드광고,홈페이지 제작과 활용에<br>
         필요한 모든 서비스를 제공하고 있습니다.
    </p>
    </section>
